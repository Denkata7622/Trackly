...
export default function HowToUsePage() {
  ...
  const steps = isBg
    ? [
        { n: "01", title: "Натисни „Слушай“", text: "ПонотИИ записва кратък аудио откъс и го подготвя за анализ." },
    ...
    : [
        { n: "01", title: "Tap Listen", text: "PonotAI records a short sample and prepares it for analysis." },
