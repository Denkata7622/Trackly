...
export default function AboutPage() {
  return (
    <section className="card p-6">
      <h1 className="cardTitle text-2xl font-bold">About PonotAI</h1>
      <p className="cardText mt-3">PonotAI helps you recognize songs and save what you find into your personal library.</p>
